...
import { BsArrowRight, BsLinkedin, BsTelephoneFill } from "react-icons/bs";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hi, I'm Alireza.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">5 years </span>
        of experience. I build{" "}
        <span className="italic">websites and applications</span> with a focus
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/alireza-dadvar"
          target="_blank"
        >
          <BsLinkedin />
        </a>
